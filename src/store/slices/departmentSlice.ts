...
import { getDepartments, addDepartment, editDepartment, deleteDepartment, addEmployee, editEmployee, deleteEmployee, addEducation, deleteEducation, addWorkExperience, deleteWorkExperience, uploadFile, deleteFile } from "../../services";
