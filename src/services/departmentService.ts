...
import { AddDepartmentResponseDto, AddEducationResponseDto, AddEmployeeResponseDto, AddWorkExperienceResponseDto, EditDepartmentResponseDto, UpdateEmployeeResponseDto, UploadFileResponseDto } from "../types/apiTypes";
...
export const addDepartment = createAsyncThunk<Array<Department>, AddDepartmentResponseDto, AsyncThunkOptions> (
    `${NAMESPACE}/addDepartments`,//MUST BE OF UNIQUE VALUE
